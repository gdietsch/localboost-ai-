...
export const trustBadges = [
  { label: '256-bit SSL Encrypted', icon: '🔒', image: null },
  { label: 'Google Partner Ready', icon: '⭐', image: null },
  { label: '30-Day Money Back', icon: '🛡️', image: null },
];

export const trustImages = [
  '/images/trust-badge-bonded.png',
  '/images/trust-badge-satisfaction.png',
];
